...
public class teste {
    ...
    public static class Personagem {
        ...
        public String toString() {
            if((altura==0)&&(peso==0)){
                return "## " + nome + " ## unknown ## unknown ## " + corDoCabelo + " ## " + corDaPele + " ## "
                    + corDosOlhos + " ## " + anoNascimento + " ## " + genero + " ## " + homeworld + " ## ";
            }
            else if (altura==0){
                return "## " + nome + " ## unknown ## " + peso + " ## " + corDoCabelo + " ## " + corDaPele + " ## "
                    + corDosOlhos + " ## " + anoNascimento + " ## " + genero + " ## " + homeworld + " ## ";
        } else if(peso==0){
                return "## " + nome + " ## " + altura + " ## unknown ## " + corDoCabelo + " ## " + corDaPele + " ## "
                    + corDosOlhos + " ## " + anoNascimento + " ## " + genero + " ## " + homeworld + " ## ";

        } else{
            return "## " + nome + " ## " + altura + " ## " +peso+ " ## " + corDoCabelo + " ## " + corDaPele + " ## "
                    + corDosOlhos + " ## " + anoNascimento + " ## " + genero + " ## " + homeworld + " ## ";
        }
