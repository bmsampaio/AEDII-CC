...
bool pesquisar(Personagem x)
{
    ...
    {
        retorno = (personagens[i].nome == x.nome);
    }
    return retorno;
}
...
int main(void)
{
    ...
    char *pos;
    pos = (char *)malloc(200 * sizeof(char));
    ...
    for (int i = 0; i < numEntrada; i++)
    {
        ...
        if (entrada2[0] == 'I' && entrada2[1] == 'I')
        {
            ler(substring(entrada2, "II ", "\n"));
            inserirInicio(personagens[countMain]);
            countMain++;
        }
        else if (entrada2[0] == 'I' && entrada2[1] == 'F')
        {
            ler(substring(entrada2, "IF ", "\n"));
            inserirFim(personagens[countMain]);
            countMain++;
        }
        else if (entrada2[0] == 'I' && entrada2[1] == '*')
        {
            pos = substring(entrada2, "I* ", "/");
            ler(substring(entrada2, pos, "\n"));
            inserir(personagens[countMain], atoi(pos));
            countMain++;
        }
        else if (entrada2[0] == 82 && entrada2[1] == 73)
        {
            printf("(%c)%s\n", 82, removerInicio().nome);
            countMain--;
        }
        else if (entrada2[0] == 82 && entrada2[1] == 70)
        {

            printf("(%c)%s\n", 82, removerFim().nome);
            countMain--;
        }
        else if (entrada2[0] == 82 && entrada2[1] == 42)
        {

            pos = substring(entrada2, "R* ", "\n");
            printf("(%c)%s\n", 82, remover(atoi(pos)).nome);
            countMain--;
        }
    }
    free(entrada2);
