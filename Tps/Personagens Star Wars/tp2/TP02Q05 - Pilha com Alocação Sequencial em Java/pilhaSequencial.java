...
class Pilha {
    ...
    public Personagens exibeUltimoValor() {
        // top
        if (this.pilhaVazia()) {
            return null;
        }
    ...
    public Personagens desempilhar() {
        // pop
        if (pilhaVazia()) {
            return null;
        }
    ...
    public void mostrar() {
        for (int i = 0; i < n; i++) {
            Personagens personagens = pilha[i];
